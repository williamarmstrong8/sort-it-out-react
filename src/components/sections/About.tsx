    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          {/* Image Frame */}
          <div className={cn(
            'transition-all duration-1000 ease-easing',
            isIntersecting 
              ? 'opacity-100 translate-x-0' 
              : 'opacity-0 -translate-x-8'
          )}>
            <div 
              className="w-full h-96 lg:h-[600px] bg-cover bg-center rounded-lg shadow-card"
              style={{
          ...
          {/* Text Content */}
          <div className={cn(
            'transition-all duration-1000 ease-easing delay-300',
            isIntersecting 
              ? 'opacity-100 translate-x-0' 
              : 'opacity-0 translate-x-8'
          )}>
            <h2 className="text-5xl font-playfair font-medium text-primary mb-4">
              About Sort It Out
            </h2>
            ...
            <blockquote className="font-playfair text-2xl italic text-primary mb-8 pl-8 py-4 border-l-4 border-accent bg-white rounded-r-lg shadow-sm">
